  ...
  return (
    <section id="experience" className="py-32 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <h2 className="text-5xl sm:text-6xl font-black tracking-tight mb-4">{experience.title}</h2>
          <p className="text-zinc-400 text-lg max-w-2xl ml-auto">
            {experience.subtitle}
          </p>
        </motion.div>
        ...
        <div className="relative">
          ...
          >
            {experiences.map((exp, index) => (
              ...
              >
                {/* Timeline Dot */}
                <div className="absolute left-6 md:left-1/2 -translate-x-1/2 w-4 h-4 rounded-full bg-gradient-to-r from-blue-500 to-cyan-500 border-4 border-zinc-950 z-10" />
